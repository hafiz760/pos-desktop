...
export default function ProfilePage() {
    ...
    const onProfileSubmit: SubmitHandler<ProfileFormData> = async (values) => {
        ...
        try {
            const result = await window.api.profile.update(user.id, {
        ...
        <div className="p-6 space-y-6 max-w-5xl mx-auto">
            ...
            <div className="grid gap-6">
                            ...
                            <form onSubmit={profileForm.handleSubmit(onProfileSubmit)} className="space-y-8 mt-4">
                                <div className="flex flex-col items-center justify-center gap-6 py-4">
                                    <div className="relative group">
                                        ...
                                        <Label htmlFor="avatar" className="absolute bottom-0 right-0 p-2 bg-[#4ade80] rounded-full cursor-pointer shadow-lg hover:bg-[#22c55e] transition-colors">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-xs text-muted-foreground uppercase mt-1 tracking-wider font-bold text-[#4ade80]">{user?.globalRole === 'ADMIN' ? 'Super Admin' : 'Store User'}</p>
                                    </div>
                                </div>
                ...
                <Card className="border-border bg-card">
                    ...
                    <CardContent>
                        <Form {...passwordForm}>
                            <form onSubmit={passwordForm.handleSubmit(onPasswordSubmit)} className="space-y-6 mt-4">
