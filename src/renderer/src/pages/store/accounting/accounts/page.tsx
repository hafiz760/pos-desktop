...
export default function AccountsPage() {
  ...
  const totalRecords = accountsData?.total || 0;
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (item: any) => (
        <span className="font-medium text-foreground">{item.accountName}</span>
      ),
    },
    {
      header: "Type",
    ...
    },
    {
      ...
      render: (item: any) => {
        ...
        return (
          <span
            className={`font-bold ${
              isNegative ? "text-red-400" : "text-[#4ade80]"
            }`}
          >
        ...
        <div className="flex items-center gap-1.5">
          <div
            className={`w-2 h-2 rounded-full ${
              item.isActive ? "bg-[#4ade80]" : "bg-muted"
            }`}
          />
    ...
    <div className="space-y-6">
      ...
      >
        <DialogContent className="bg-background border-border text-foreground">
          <DialogHeader>
            <DialogTitle>
              {isEditOpen ? "Edit Account" : "Add New Account"}
            </DialogTitle>
          </DialogHeader>
          <Form {...form}>
            <form
            ...
            >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {isEditOpen ? "Current Balance" : "Opening Balance"}
                    </FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                    ...
                    {isEditOpen && (
                      <p className="text-[10px] text-yellow-500 font-medium mt-1">
                        Warning: Manually editing the balance may cause
                        discrepancies with transaction history.
                      </p>
                    )}
                    <FormMessage />
                  </FormItem>
